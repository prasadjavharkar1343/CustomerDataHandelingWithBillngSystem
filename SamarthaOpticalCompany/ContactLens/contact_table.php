...
$id = $_GET['id'];
$result = mysqli_query($mysqli, "SELECT right_sph1,right_cyl1,right_axis1,right_vn1 FROM contact_lens where id=$id"); 
$result2 = mysqli_query($mysqli, "SELECT right_sph2,right_cyl2,right_axis2,right_vn2 FROM contact_lens where id=$id");
$result3 = mysqli_query($mysqli, "SELECT left_sph1,left_cyl1,left_axis1,left_vn1 FROM contact_lens where id=$id"); 
$result4 = mysqli_query($mysqli, "SELECT left_sph2,left_cyl2,left_axis2,left_vn2 FROM contact_lens where id=$id");
?>
