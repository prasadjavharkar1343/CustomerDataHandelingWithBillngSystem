...
<table align="center" width='100%' border=5>
  <thead>
        <tr bgcolor='#AAAAAA'>
            ...
            <th bgcolor='#00FF00'><b>Contact_Lens Type<b></th>
...
if($mysqli->connect_error){
    echo 'Connection Faild: '.$con->connect_error;
        ...
        $sql="select * from contact_lens where name like '%$search_value%'";
        ...
        $res=$mysqli->query($sql);
            ...
            echo "<td bgcolor='#AAAAAA'><a href=\"contact_table.php?id=$row[id]\">Show_Specs_No</a></td>";
